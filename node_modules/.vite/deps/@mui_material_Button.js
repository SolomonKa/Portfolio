...
} from "./chunk-4WE4REYD.js";
import {
  ButtonBase_default
} from "./chunk-6GOEIYZH.js";
import {
  chainPropTypes
} from "./chunk-ITGWAFDM.js";
import {
  memoTheme_default
} from "./chunk-YJ3HOKKZ.js";
import {
  clsx_default,
  composeClasses,
  css,
  ...
  useDefaultProps,
  useId
} from "./chunk-DFDERIEH.js";
import {
  require_jsx_runtime
} from "./chunk-GL6TLX6B.js";
import "./chunk-6MBIOSIA.js";
import {
  __toESM,
  require_react
...
var CircularProgress = React4.forwardRef(function CircularProgress2(inProps, ref) {
  ...
  return (0, import_jsx_runtime3.jsx)(CircularProgressRoot, {
    className: clsx_default(classes.root, className),
    style: {
      width: size,
      height: size,
    ...
    ...rootProps,
    ...other,
    children: (0, import_jsx_runtime3.jsxs)(CircularProgressSVG, {
      className: classes.svg,
      ownerState,
      viewBox: `${SIZE / 2} ${SIZE / 2} ${SIZE} ${SIZE}`,
      children: [enableTrackSlot ? (0, import_jsx_runtime3.jsx)(CircularProgressTrack, {
        ...
        "aria-hidden": "true"
      }) : null, (0, import_jsx_runtime3.jsx)(CircularProgressCircle, {
...
true ? CircularProgress.propTypes = {
   ...
   * @default false
   */
  enableTrackSlot: import_prop_types2.default.bool,
  /**
...
var Button = React7.forwardRef(function Button2(inProps, ref) {
  ...
  const startIcon = (startIconProp || loading && loadingPosition === "start") && (0, import_jsx_runtime4.jsx)(ButtonStartIcon, {
    className: classes.startIcon,
    ownerState,
    children: startIconProp || (0, import_jsx_runtime4.jsx)(ButtonLoadingIconPlaceholder, {
      className: classes.loadingIconPlaceholder,
      ownerState
    })
  });
  const endIcon = (endIconProp || loading && loadingPosition === "end") && (0, import_jsx_runtime4.jsx)(ButtonEndIcon, {
    className: classes.endIcon,
    ownerState,
    children: endIconProp || (0, import_jsx_runtime4.jsx)(ButtonLoadingIconPlaceholder, {
      className: classes.loadingIconPlaceholder,
      ownerState
    })
  });
  ...
  const loader = typeof loading === "boolean" ? (
    ...
    (0, import_jsx_runtime4.jsx)("span", {
      ...
      children: loading && (0, import_jsx_runtime4.jsx)(ButtonLoadingIndicator, {
